...
public class Library {
	...
	public static void changeLoginName(String oldUsername, String newUsername) {
		System.out.println(newUsername);
		for (String username : Library.logins) {
	...
	public static void compileAccounts() throws IOException {
		...
		Datastore.setAsync("src/dataSet/accounts.txt", masterString);
	}
	...
	// compiles the list of users into readable text
		public static void compileResources() throws IOException {
			...
			Datastore.setAsync("src/dataSet/resources.txt", masterString);
		}
	...
	public static void compileExecutions() throws IOException {		
		...
		for (User person : Library.requestItems) {
			...
			String compileText = "Request, " + resourceType + ", " + resourceTitle + ", " + currentCopy.getCopyID() + ", " + person.getUsername();
		...
		for (User person : Library.collectItems) {
			...
			String compileText = "Collect, " + resourceType + ", " + resourceTitle + ", " + currentCopy.getCopyID() + ", " + person.getUsername();
			masterString = masterString +  compileText + spacer;
		}
		...
		Datastore.setAsync("src/dataSet/execute.txt", masterString);
	}
	...
	public static void forceOut() throws IOException {
		Library.currentLogin = null;
	}
	...
	public static void preloadAccounts(){
		String accountsFileLocation = "src/dataSet/accounts.txt";
	...
	public static void preloadResources(){
		String resourcesFileLocation = "src/dataSet/Resources.txt";
	...
	public static void preloadExecutions() throws IOException {
		Scanner fileText = new Scanner(Datastore.getAsync("src/dataSet/Execute.txt"));
